...
$(document).ready(function(){
    ...
    function onFrame() {
        ...
        if (s0 && s1) {
            ...
            //socket.emit('tilt', { LR: MotionTracker.tiltLR, FB: MotionTracker.tiltFB });
            socket.emit('tilt', { LR: MotionTracker.smoothTiltLR, FB: MotionTracker.smoothTiltFB });
        }
    }
